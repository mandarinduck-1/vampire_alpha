...
namespace unitcell{
   ...
   void initialise(unit_cell_t & unit_cell){
      ...
      else if(uc::internal::crystal_structure == "cr_in_crsbr"    ) uc::internal::build_cr_in_crsbr(            unit_cell ); //由唐愈涵添加
      else if(uc::internal::crystal_structure == "cr_in_crbr3"    ) uc::internal::build_cr_in_crbr3(            unit_cell ); //由唐愈涵添加
