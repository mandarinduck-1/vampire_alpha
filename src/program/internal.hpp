...
namespace program
{
   ...
   namespace internal
   {
      ...
      // 唐愈涵加入以实现分段磁滞回线
      extern std::vector<SegmentParams> segmented_hyst_segments;
      ...
      public:
         ...
         // constructor
         mp_t(const unsigned int max_materials = 100) : test(0.0) // constructor initialisation of test variable
         {
