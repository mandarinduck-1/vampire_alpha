...
//枚举定义了激光加热脉冲的类型（如方波、两温模型、双脉冲两温模型和双脉冲方波）
...
namespace sim{
	...
	//用于磁记录轨道结构的参数，如比特宽度、深度、间距、速度、轨道数和飞行高度等
    ...
    //获取自旋转移矩阵（STT）相关的极化方向、弛豫常数、进动常数等参数
}
